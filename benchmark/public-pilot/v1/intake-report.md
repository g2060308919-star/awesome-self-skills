...
| Pilot ID | Origin | Owner/repository and binding evidence | Immutable commit | PRD path | Same-commit license path / reported license | Machine screening note |
|---|---|---|---|---|---|---|
...
| PF-TR-03 | replacement-TR-A1 | [`unbrowse-ai/unbrowse`](https://github.com/unbrowse-ai/unbrowse) | [`e844f8f6af03b2ca9f0c466ac2262efceb2cf8ca`](https://github.com/unbrowse-ai/unbrowse/commit/e844f8f6af03b2ca9f0c466ac2262efceb2cf8ca) | [`ACCEPTANCE-CRITERIA.md`](https://github.com/unbrowse-ai/unbrowse/blob/e844f8f6af03b2ca9f0c466ac2262efceb2cf8ca/docs/architecture/ACCEPTANCE-CRITERIA.md) | [`LICENSE`](https://github.com/unbrowse-ai/unbrowse/blob/e844f8f6af03b2ca9f0c466ac2262efceb2cf8ca/LICENSE) / `MIT` | `accepted-for-pilot-freeze`; payment-only scope over subscription, x402 retry/idempotency, and settlement criteria; formal `ADMIT` pending. |
...
| PF-WF-04 | replacement-WF-B2 | [`dinpd/AgentAction`](https://github.com/dinpd/AgentAction) | [`84722312663cc46a7d928d0d883332f8d6d1d821`](https://github.com/dinpd/AgentAction/commit/84722312663cc46a7d928d0d883332f8d6d1d821) | [`agentaction-gateway-prd.md`](https://github.com/dinpd/AgentAction/blob/84722312663cc46a7d928d0d883332f8d6d1d821/docs/agentaction-gateway-prd.md) | [`LICENSE`](https://github.com/dinpd/AgentAction/blob/84722312663cc46a7d928d0d883332f8d6d1d821/LICENSE) / `Apache-2.0` | `accepted-for-pilot-freeze`; challenge/allow/deny workflow, approval/grant binding, exact replay and fail-closed context drift; formal `ADMIT` pending. |
...
| Pilot ID | Origin | Owner/repository and binding evidence | Immutable commit | PRD path | Same-commit license path / reported license | Machine screening note |
|---|---|---|---|---|---|---|
| PF-AS-01 | EB-A-01 | [`marketcalls/openalgo`](https://github.com/marketcalls/openalgo) | [`01910584c4c7e89583ebdaaf8a3ce3a006155e68`](https://github.com/marketcalls/openalgo/commit/01910584c4c7e89583ebdaaf8a3ce3a006155e68) | [`docs/scalping/PRD.md`](https://github.com/marketcalls/openalgo/blob/01910584c4c7e89583ebdaaf8a3ce3a006155e68/docs/scalping/PRD.md) | [`License.md`](https://github.com/marketcalls/openalgo/blob/01910584c4c7e89583ebdaaf8a3ce3a006155e68/License.md) / `AGPL-3.0` | `accepted-for-pilot-freeze`; event buses, triggers, reconnect and failure behavior; formal `ADMIT` pending. |
...
| PF-AS-04 | replacement-AS-C1 | [`cloudflare/agents`](https://github.com/cloudflare/agents) | [`73d2ed457ba02035d2b1d3efc785c012254ac216`](https://github.com/cloudflare/agents/commit/73d2ed457ba02035d2b1d3efc785c012254ac216) | [`queue.md`](https://github.com/cloudflare/agents/blob/73d2ed457ba02035d2b1d3efc785c012254ac216/docs/agents/queue.md) | [`LICENSE`](https://github.com/cloudflare/agents/blob/73d2ed457ba02035d2b1d3efc785c012254ac216/LICENSE) / `MIT` | `accepted-for-pilot-freeze`; persistent FIFO callback queue, automatic processing, bounded exponential-backoff retry and dequeue outcomes; formal `ADMIT` pending. |
| PF-AS-05 | replacement-AS-C2 | [`mikigraf/Runmill`](https://github.com/mikigraf/Runmill) | [`4fab5115bba155f5dbb0f9afc10ad582663dac2c`](https://github.com/mikigraf/Runmill/commit/4fab5115bba155f5dbb0f9afc10ad582663dac2c) | [`asf-production-worker-prd.md`](https://github.com/mikigraf/Runmill/blob/4fab5115bba155f5dbb0f9afc10ad582663dac2c/docs/asf-production-worker-prd.md) | [`LICENSE`](https://github.com/mikigraf/Runmill/blob/4fab5115bba155f5dbb0f9afc10ad582663dac2c/LICENSE) / `MIT` | `accepted-for-pilot-freeze`; immediate run-ID, durable events, checkpoint recovery/reconciliation and terminal retry disposition; formal `ADMIT` pending. |
...
| PF-TM-02 | EB-T-03 | [`juniper-tc02e/ayin`](https://github.com/juniper-tc02e/ayin) | [`773fdd11e6cdc1c61234440ccdbdcd0188d3bcd8`](https://github.com/juniper-tc02e/ayin/commit/773fdd11e6cdc1c61234440ccdbdcd0188d3bcd8) | [`docs/Ayin-PRD-and-SaaS-Plan.md`](https://github.com/juniper-tc02e/ayin/blob/773fdd11e6cdc1c61234440ccdbdcd0188d3bcd8/docs/Ayin-PRD-and-SaaS-Plan.md) | [`LICENSE`](https://github.com/juniper-tc02e/ayin/blob/773fdd11e6cdc1c61234440ccdbdcd0188d3bcd8/LICENSE) / `AGPL-3.0` | `accepted-for-pilot-freeze`; rate limits, retention windows and entitlements; hackathon origin disclosed; formal `ADMIT` pending. |
| PF-TM-03 | EB-T-04 | [`yat-hk/yat`](https://github.com/yat-hk/yat) | [`0c206d5ea88b5fe256904d960875d9d0af5c6309`](https://github.com/yat-hk/yat/commit/0c206d5ea88b5fe256904d960875d9d0af5c6309) | [`PRD.md`](https://github.com/yat-hk/yat/blob/0c206d5ea88b5fe256904d960875d9d0af5c6309/PRD.md) | [`LICENSE`](https://github.com/yat-hk/yat/blob/0c206d5ea88b5fe256904d960875d9d0af5c6309/LICENSE) / `GPL-3.0` | `accepted-for-pilot-freeze`; update/sleep/freshness windows; agent-first/AI-written disclosure is not disqualifying; formal `ADMIT` pending. |
| PF-TM-04 | EB-T-05 | [`marketcalls/openrag`](https://github.com/marketcalls/openrag) | [`76303a9a88cbb779093a682b2be6c645eef7ed8b`](https://github.com/marketcalls/openrag/commit/76303a9a88cbb779093a682b2be6c645eef7ed8b) | [`docs/prd.md`](https://github.com/marketcalls/openrag/blob/76303a9a88cbb779093a682b2be6c645eef7ed8b/docs/prd.md) | [`LICENSE`](https://github.com/marketcalls/openrag/blob/76303a9a88cbb779093a682b2be6c645eef7ed8b/LICENSE) / `AGPL-3.0` | `accepted-for-pilot-freeze`; monthly allocations, reset day, debit and exhaustion; Codex collaboration disclosed; formal `ADMIT` pending. |
