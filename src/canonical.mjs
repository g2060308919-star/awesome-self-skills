...
const SET_ARRAY_PATHS = new Set([
  ...
  '/cases', '/cases/obligation_ids', '/cases/source_claim_ids', '/cases/fact_ids', '/cases/evidence_refs', '/cases/preconditions/source_claim_ids', '/cases/testability_profile/capabilities', '/cases/testability_profile/observers', '/cases/testability_profile/controls', '/cases/execution_signature/oracle_refs', '/cases/execution_signature/test_point_ids', '/execution_signature/oracle_refs', '/execution_signature/test_point_ids', '/obligation_dispositions', '/obligation_dispositions/case_ids', '/obligation_dispositions/evidence_refs', '/exploratory_candidates', '/exploratory_candidates/source_claim_ids',
  '/grounded', '/grounded/obligation_ids', '/grounded/evidence_refs', '/conditional', '/conditional/obligation_ids', '/blocked', '/exploratory', '/coverage/not_applicable', '/root_issue_dispositions', '/blockers/affected_obligation_ids'
]);
