...
const ORDERED_ARRAY_PATHS = new Set(['/steps', '/action_path', '/flow', '/flow_sequence', '/sequence', '/transition_order', '/cases/steps', '/cases/execution_signature/action_path', '/execution_signature/action_path']);
const SET_ARRAY_PATHS = new Set([
  ...
  '/sources', '/locators', '/source_policy/rules', '/source_policy/rules/source_ids', '/source_policy/rules/supersedes', '/decision_records', '/decision_records/root_issue_ids', '/decision_records/affected_obligation_ids', '/clarification_events', '/clarification_events/root_issue_ids',
  '/claims', '/claims/source_locator_ids', '/claims/parent_claim_ids', '/fact_ledger',
  '/views', '/views/elements', '/views/elements/source_claim_ids', '/interaction_matrix', '/interaction_matrix/module_ids', '/interaction_candidates', '/interaction_candidates/module_ids',
  ...
  '/cases', '/cases/obligation_ids', '/cases/source_claim_ids', '/cases/execution_signature/oracle_refs', '/cases/execution_signature/test_point_ids', '/execution_signature/oracle_refs', '/execution_signature/test_point_ids', '/obligation_dispositions', '/obligation_dispositions/case_ids', '/exploratory_candidates',
  '/grounded', '/conditional', '/blocked', '/exploratory', '/root_issue_dispositions'
]);
...
const COLLECTION_ID_FIELDS = new Map([
  ['/sources', 'source_id'], ['/locators', 'locator_id'], ['/source_policy/rules', 'rule_id'], ['/decision_records', 'decision_id'], ['/clarification_events', 'event_id'], ['/claims', 'claim_id'], ['/fact_ledger', 'fact_id'], ['/views', 'view_id'], ['/interaction_candidates', 'candidate_id'], ['/obligations', 'obligation_id'], ['/fact_routes', 'fact_id'], ['/interaction_routes', 'candidate_id'], ['/cases', 'case_id'], ['/obligation_dispositions', 'obligation_id'], ['/exploratory_candidates', 'exploratory_id'], ['/grounded', 'case_id'], ['/conditional', 'case_id'], ['/blocked', 'obligation_id'], ['/exploratory', 'exploratory_id'], ['/root_issue_dispositions', 'root_issue_id']
]);
