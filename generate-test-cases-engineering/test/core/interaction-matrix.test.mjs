...
test('interaction matrix rejects an empty audit instead of treating it as no signal', () => {
  const result = auditInteractionMatrix({ schema_version: '2.1.0', source_revision: 0, views: [], interaction_matrix: [], obligation_inputs: { view_contexts: [], terminal_fact_routes: [], custom_responsibilities: [], combination_requests: [] }, interaction_candidates: [] });
...
test('interaction matrix audits 120 declared modules and 49,980 cells in bounded time', () => {
  ...
  const artifact = { schema_version: '2.1.0', source_revision: 0, views: [], interaction_matrix: matrix, obligation_inputs: { view_contexts: [], terminal_fact_routes: [], custom_responsibilities: [], combination_requests: [] }, interaction_candidates: [] };
