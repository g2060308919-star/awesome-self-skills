...
import {
  ...
  verifyCandidateEvidenceBytes as verifyReleaseCandidateEvidenceBytes
...
export async function deriveCandidateBinding(
  ...
  return deriveReleaseCandidateBinding(manifestPath, expectedManifestDigest, candidateRoot);
}
...
export function reconcileCandidateBindings(initial, final) {
  return reconcileReleaseCandidateBindings(initial, final);
}
...
export async function verifyCandidateEvidenceBytes(candidateRoot, head, filename, bytes) {
  return verifyReleaseCandidateEvidenceBytes(candidateRoot, head, filename, bytes);
}
